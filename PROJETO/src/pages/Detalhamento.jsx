    ...
    return (
        <>
            <Base>
                ...
                email={projeto.email} nome2={projeto.nome2} nome3={projeto.nome3} curso2={projeto.curso2} curso3={projeto.curso3} email2={projeto.email2} email3={projeto.email3} periodo={projeto.periodo} periodo2={projeto.periodo2}/>
            </Base>
