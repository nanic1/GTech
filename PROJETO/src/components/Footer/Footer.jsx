...
const Rodape = () => {
    return(
        <Footer>
            ...
            <div id="conteiner">
                <div class='minas'>
                    <p className="amarelo">MINAS GERAIS</p>
                    <p className="azul">R. Rio Grande do Norte,300</p>
                    <p className="azul">Funcionários</p>
                    <p className="azul">Belo Horizonte-MG</p>
                ...
                <div class='distrito'>
                    ...
                    <p className="azul">Brasília - DF</p>
                    <p className="azul">0800 771 8020</p>
                ...
                <div class='sao-paulista'>
                    ...
                    <p className="azul">São Paulo - SP</p>
                    <p className="azul">0800 771 8020</p>
